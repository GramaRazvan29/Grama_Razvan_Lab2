...
namespace Grama_Razvan_Lab2.Data
{
    public class Grama_Razvan_Lab2Context : DbContext
    {
        ...
        public DbSet<Grama_Razvan_Lab2.Models.Author> Author { get; set; } = default!;
        public DbSet<Grama_Razvan_Lab2.Models.BookCategory> BookCategory { get; set; } = default!;
        public DbSet<Grama_Razvan_Lab2.Models.Category> Category { get; set; } = default!;
